...
<div class="p-main-visual">
      ...
      <!-- <div class="p-main-visual__group">
        ...
        <img class="p-main-visual__image" src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/common/main-visual.webp" width="1326" height="920" alt="" />
      </div> -->
    </div>
    ...
    <main class="l-main-content">
      ...
      <section class="l-main-content__section p-facility-intro">
        <div class="p-facility-intro__wrapper js-facility-wrapper">
          ...
          <p class="p-facility-intro__paragraph">
            ...
            <span
              >コンテナ製のレンタルバイクガレージを18棟備えた施設です。</span
            >
            <span
              >その他、レンタルスペース、レンタルキッチントレーラーも備え、</span
            >
            <span
              >豊かなライフスタイルを加速させるための魅力的な空間です。</span
            >
        ...
        <div class="p-plan__inner">
          <div class="p-plan__main">
            ...
            <p class="p-plan__main-price">
              月額／<span class="p-plan__main-price-number">39,000</span
              ><span class="p-plan__main-price-unit">YEN</span>～
            </p>
          ...
          <div class="p-plan__grid">
            <div class="p-plan__sub">
              ...
              <p class="p-plan__sub-price">
                1時間／<span class="p-plan__sub-price-number">2,500</span
                ><span class="p-plan__sub-price-unit">YEN</span>～
              </p>
            ...
            <div class="p-plan__sub">
              ...
              <p class="p-plan__sub-price2">
                1日／<span class="p-plan__sub-price-number">5,000</span
                ><span class="p-plan__sub-price-unit">YEN</span>～
              </p>
              <p class="p-plan__sub-description">
      ...
      <section class="l-main-content__section p-map">
        <h2 class="p-map__title js-title">
          ...
          <!-- <span>HASHIMA BASE <br><span class="map__title_size">MAP</span></span> -->
        </h2>
        <img
          class="p-map__map"
      ...
      <section class="l-main-content__section p-information">
        ...
        <!-- <ul class="p-information__list">
          <li class="p-information__item">
            <p class="p-information__date">2025.04.00</p>
            <a class="p-information__link" href="#">
              <p class="p-information__news">Renewal OPEN !</p>
            </a>
          </li>
          <li class="p-information__item">
            <p class="p-information__date">2025.04.00</p>
            <a class="p-information__link" href="#">
              <p class="p-information__news">
                来週の土曜日、日曜日は全国のバイカー集合のイベントです。
              </p>
            </a>
          </li>
          <li class="p-information__item">
