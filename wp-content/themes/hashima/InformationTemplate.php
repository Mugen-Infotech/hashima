                ...
                ?>
                        ...
                        <div class="flex flex-col" data-category="<?php echo esc_attr($category_slug); ?>">
                            <a href="<?php echo esc_url($permalink); ?>">
                                <img src="<?php echo esc_url($image_url); ?>" alt="<?php echo esc_attr($title); ?>" class="w-full h-[300px] small-image-h sm:h-[430px] md:h-[200px] lg:h-[250px] xl:h-[300px] object-cover bg-white border border-gray-200" />
                            </a>
