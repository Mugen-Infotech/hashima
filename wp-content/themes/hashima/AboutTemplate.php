...
<main class="l-main-content pt-10">
  <section class="py-12 md:py-10 !pb-20">
    <div class="flex flex-col lg:flex-row min-h-screen max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="lg:w-2/3">
        ...
        <div
          ...
          <p>
            ...
            <br />
            <span>ハーレーと言えばR66やオールドアメリカの雰囲気が良く、ラスベガスに行ったときに、当時はハーレーの食料店がホテルの前にあり、数日の旅行で毎日2回行き、日本には無い解放的な感じや昨日のアメリカ映画に憧れました。
            </span>
            <br />
            <span>
